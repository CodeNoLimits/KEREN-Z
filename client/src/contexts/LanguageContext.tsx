...
export const translations = {
  he: {
    ...
    downloadDescription:
      "הורדו ספרי ברסלב במגוון שפות - כל הספרים זמינים בחינם לקהילה",
    search: "חיפוש",
    ...
    freeDownloadNote:
      "כל הספרים זמינים להורדה חינמית לפי רוח הברסלב - התורה שלמה תהיה חינם",
  ...
  en: {
    ...
    storeSubtitle:
      "Comprehensive collection of Rabbi Nachman of Breslov and his students' books at special prices",
    filterBy: "Filter by..",
    ...
    downloadDescription:
      "Download Breslov books in multiple languages - all books available free to the community",
    search: "Search",
    ...
    freeDownloadNote:
      "All books are available for free download in the spirit of Breslov - the entire Torah should be free",
    ...
    lookingForMore:
      "Looking for another book? Contact us and we'll find it for you!",
  ...
  fr: {
    ...
    storeSubtitle:
      "Collection complète des livres de Rabbi Nachman de Breslov et de ses étudiants à prix spéciaux",
    ...
    downloadDescription:
      "Téléchargez des livres Breslov en plusieurs langues - tous les livres sont disponibles gratuitement pour la communauté",
    search: "Recherche",
    ...
    freeDownloadNote:
      "Tous les livres sont disponibles en téléchargement gratuit dans l'esprit de Breslov - toute la Torah devrait être gratuite",
    ...
    lookingForMore:
      "Vous cherchez un autre livre ? Contactez-nous et nous le trouverons pour vous !",
  ...
  es: {
    ...
    storeSubtitle:
      "Colección completa de libros del Rabino Nachman de Breslov y sus estudiantes a precios especiales",
    ...
    lookingForMore:
      "¿Busca otro libro? ¡Contáctenos y lo encontraremos para usted!",
  ...
  ru: {
    ...
    storeSubtitle:
      "Полная коллекция книг Рабби Нахмана из Бреслов и его учеников по специальным ценам",
    ...
    lookingForMore:
      "Ищете другую книгу? Свяжитесь с нами, и мы найдем её для вас!",
...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  // Global dir/lang attribute management
  useEffect(() => {
