...
const translations = {
  he: {
    ...
    description:
      "גלו את העומק הרוחני של תורת רבי נחמן מברסלב דרך מאמרים, הרצאות וחכמה עתיקה המותאמת לעולם המודרני",

    // Hero Section
    heroTitle: "קרן סגנון",
    heroSubtitle: "מעיינות החכמה הברסלבית",
    heroDescription:
      "מסע עמוק אל תוך אוצרות הנשמה של רבי נחמן מברסלב זצ״ל - תורה, חסידות ואמונה פשוטה המאירה את הדרך לכל דור",
    heroQuote:
      '"מִצְוָה גְּדוֹלָה לִהְיוֹת בְּשִׂמְחָה תָּמִיד" - רבי נחמן מברסלב',
  ...
  en: {
    ...
    description:
      "Discover the spiritual depth of Rabbi Nachman of Breslov's teachings through articles, lectures and ancient wisdom adapted for the modern world",

    heroTitle: "Keren Style",
    heroSubtitle: "Springs of Breslov Wisdom",
    heroDescription:
      "A deep journey into the soul treasures of Rabbi Nachman of Breslov - Torah, Chassidus and simple faith that illuminates the path for every generation",
    heroQuote:
      '"It is a great mitzvah to always be happy" - Rabbi Nachman of Breslov',
  ...
  fr: {
    ...
    description:
      "Découvrez la profondeur spirituelle des enseignements de Rabbi Nachman de Breslov à travers articles, conférences et sagesse ancienne adaptée au monde moderne",

    heroTitle: "Style Keren",
    heroSubtitle: "Sources de la Sagesse de Breslov",
    heroDescription:
      "Un voyage profond dans les trésors de l'âme de Rabbi Nachman de Breslov - Torah, Hassidisme et foi simple qui illumine le chemin pour chaque génération",
    heroQuote:
      "\"C'est une grande mitsva d'être toujours heureux\" - Rabbi Nachman de Breslov",
...
זה לא בריחה מהעולם המודרני - זה הדרך להישאר שפויים בו.`,
    },
    {
      ...
      readTime: "15 דקות",
      excerpt:
        "המדע המודרני מוכיח את דברי רבי נחמן על השמחה כרפואה לנפש ולגוף...",
...
השמחה אינה תלויה בנסיבות חיצוניות - זו החלטה פנימית שאפשר לקבל בכל רגע. זה מה שהופך את תורת רבי נחמן למהפכנית: השמחה היא לא תוצאה של חיים טובים - השמחה היא הדרך לחיים טובים.`,
    },
    {
      ...
      readTime: "18 דקות",
      excerpt:
        "איך האמונה הפשוטה של רבי נחמן מתמודדת עם האתגרים המדעיים של המאה ה-21...",
...
האמונה הפשוטה היא לא נחיתות מול המדע - זו השלמה מושלמת שלו.`,
  ...
  const prevQuote = () => {
    setCurrentQuoteIndex(
      (prev) => (prev - 1 + dailyPearls.length) % dailyPearls.length,
    );
  };
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-red-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700"
    ...
    >
      ...
      >
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          ...
          >
            <Crown
              className="w-32 h-32 mx-auto text-orange-500 mb-6 animate-pulse"
              data-testid="icon-crown"
            />
            <h1
              className="text-7xl font-bold bg-gradient-to-r from-orange-600 via-red-600 to-purple-600 bg-clip-text text-transparent mb-6"
              data-testid="text-main-title"
            >
              {t.heroTitle}
            </h1>
            <h2
              className="text-3xl text-gray-700 dark:text-gray-300 mb-8 font-light"
              data-testid="text-subtitle"
            >
              {t.heroSubtitle}
            </h2>
            <p
              className="text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-4xl mx-auto leading-relaxed"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-wrap justify-center gap-4">
            {[
              ...
              {
                id: "videos",
                label: currentLanguage === "he" ? "וידיאוים" : "Videos",
                icon: Play,
              },
            ...
            >
              <div className="text-center mb-12">
                <h2
                  ...
                  data-testid="text-teachings-title"
                >
                  {t.teachingsTitle}
                </h2>
                <p
                  className="text-xl text-gray-600 dark:text-gray-400"
                  data-testid="text-teachings-subtitle"
                >
                  {t.teachingsSubtitle}
                </p>
              </div>
                  ...
                  >
                    <div className="p-6">
                      <div className="flex items-center mb-4">
                        {teaching.icon}
                        <h3
                          className="text-2xl font-bold text-gray-800 dark:text-gray-200 mr-4"
                          data-testid={`teaching-title-${teaching.id}`}
                        >
                          {getTitle(teaching)}
                        </h3>
                      </div>
                      ...
                      <div
                        className="bg-orange-50 dark:bg-orange-900/30 p-4 rounded-lg mb-4"
                        dir="rtl"
                      >
                        <p
                          className="text-lg font-semibold text-orange-800 dark:text-orange-200"
                          data-testid={`teaching-content-${teaching.id}`}
                        >
                          {teaching.content}
                        </p>
                        <p
                          className="text-sm text-orange-600 dark:text-orange-400 mt-2"
                          data-testid={`teaching-source-${teaching.id}`}
                        >
                          {teaching.source}
                        </p>
                      </div>
                      ...
                      <div
                        className={`transition-all duration-300 ${expandedTeaching === teaching.id ? "max-h-none" : "max-h-24 overflow-hidden"}`}
                      >
                        <p
                          className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4"
                          data-testid={`teaching-description-${teaching.id}`}
                        >
                          {teaching.description}
                        </p>

                        {expandedTeaching === teaching.id &&
                          teaching.practicalTips && (
          ...
          {activeSection === "quotes" && (
            ...
            >
              <div className="text-center mb-12">
                ...
                <p
                  className="text-xl text-gray-600 dark:text-gray-400"
                  data-testid="text-quotes-subtitle"
                >
              ...
              >
                ...
                <p className="text-lg opacity-80">{getCurrentQuote().source}</p>
          ...
          {activeSection === "practices" && (
            ...
            >
              <div className="text-center mb-12">
                ...
                <p
                  className="text-xl text-gray-600 dark:text-gray-400"
                  data-testid="text-practices-subtitle"
                >
                  {t.practicalSubtitle}
                </p>
              </div>
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      <h3
                        ...
                        data-testid={`practice-title-${index}`}
                      >
                        {getTitle(exercise)}
                      </h3>
                    ...
                    <p
                      ...
                      data-testid={`practice-description-${index}`}
                    >
            ...
            >
              <div className="text-center mb-12">
                <h2 className="text-5xl font-bold text-gray-800 dark:text-gray-200 mb-4">
                  {currentLanguage === "he"
                    ? "ספרי יסוד ברסלב"
                    : "Essential Breslov Books"}
                </h2>
                <p className="text-xl text-gray-600 dark:text-gray-400">
                  {currentLanguage === "he"
                    ? "האוסף המרכזי לעיון והתעמקות"
                    : "Core collection for study and contemplation"}
                </p>
              </div>
                ...
                {essentialBooks.map((book, index) => (
                  ...
                  >
                    ...
                    <p
                      ...
                      data-testid={`book-description-${index}`}
                    >
                      {book.description}
                    </p>
          ...
          {activeSection === "wisdom" && (
            ...
            >
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600 dark:text-gray-400">
                  {currentLanguage === "he"
                    ? "תובנות עמוקות לדורנו"
                    : "Deep insights for our generation"}
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                >
                  ...
                  <p className="text-xl leading-relaxed">
                    רבי נחמן מלמד אותנו לראות את העולם בעיניים חדשות - לחפש את
                    הטוב בכל מצב, למצוא את ה' בכל רגע, ולחיות עם אמונה פשוטה גם
                    בעולם מורכב.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-xl leading-relaxed">
                    בכל יהודי בוערת אש קדושה - הנשמה שמחכה להתעורר. תורת רבי
                    נחמן מלמדת איך להצית את האש הזאת ולהפוך כל רגע לעבודת ה'
                    אמיתית.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-xl leading-relaxed">
                    כמו עץ שגדל לאט לאט, כך הנשמה צריכה זמן להתפתח. רבי נחמן
                    מלמד סבלנות עם העצמי, חיזוק מתמיד, ובטחון שכל יהודי יכול
                    להגיע למעלות גבוהות.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-xl leading-relaxed">
                    הדרך הברסלבית היא דרך של אהבה - אהבת ה', אהבת ישראל, ואהבה
                    עצמית בריאה. כשנאהב בפשטות, הכל נעשה קל וטבעי.
                  </p>
                </motion.div>
              </div>
            </motion.section>
      ...
      >
        <div className="max-w-4xl mx-auto">
          <motion.div whileHover={{ scale: 1.02 }} className="p-8">
            ...
            <p
              ...
              data-testid="text-footer-attribution"
            >
              {t.footerAttribution}
            </p>
          </motion.div>
      ...
      {activeSection === "videos" && (
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              {currentLanguage === "he"
                ? "וידיאוים אותנטיים על תורת רבי נחמן מברסלב"
                : "Authentic videos on Rabbi Nachman of Breslov's teachings"}
            </p>
          </div>
            ...
            {[
              {
                ...
                videoId: "3uQP06r20H8",
                thumbnail:
                  "https://img.youtube.com/vi/3uQP06r20H8/maxresdefault.jpg",
              ...
              },
              {
                ...
                videoId: "RvlOCvdiUCA",
                thumbnail:
                  "https://img.youtube.com/vi/RvlOCvdiUCA/maxresdefault.jpg",
              ...
              },
              {
                ...
                videoId: "3LFVAOXVB9Y",
                thumbnail:
                  "https://img.youtube.com/vi/3LFVAOXVB9Y/maxresdefault.jpg",
