...
export default function BreslovVideos() {
  ...
  const breslovVideos = [
    {
      ...
      description:
        'התורה המפורסמת של רבי נחמן על השמחה הנצחית - "מצוה גדולה להיות בשמחה תמיד"',
      descriptionEn:
        'Rabbi Nachman\'s famous teaching on eternal joy - "It is a great mitzvah to always be happy"',
      descriptionFr:
        "L'enseignement célèbre de Rabbi Nachman sur la joie éternelle",
      duration: "23:45",
    ...
    },
    {
      ...
      description:
        'התורה החזקה של רבי נחמן נגד הייאוש - "אין שום יאוש בעולם כלל"',
      descriptionEn: "Rabbi Nachman's powerful teaching against despair",
      descriptionFr:
        "L'enseignement puissant de Rabbi Nachman contre le désespoir",
      duration: "31:12",
    ...
    },
    {
      ...
      descriptionEn:
        "Practical guidance for personal prayer with God in our language",
    ...
    },
    {
      ...
      descriptionFr:
        "Un des 13 contes authentiques de Rabbi Nachman de Breslov",
      duration: "45:20",
      category: "מעשיות",
      speaker: "קרן רבי ישראל הקרן",
      views: "950K",
    ...
    },
    {
      ...
      descriptionEn:
        "Authentic Breslov melodies to strengthen the soul and enthusiasm",
  ...
  const getTitle = (video: any) => {
    switch (currentLanguage) {
      ...
      case "fr":
        return video.titleFr || video.title;
      default:
        return video.title;
    }
  };
  ...
  const getDescription = (video: any) => {
    switch (currentLanguage) {
      case "en":
        return video.descriptionEn || video.description;
      case "fr":
        return video.descriptionFr || video.description;
      default:
    ...
    >
      ...
      >
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          ...
          >
            <Flame
              className="w-24 h-24 mx-auto text-orange-500 mb-6 animate-pulse"
              data-testid="icon-flame"
            />
            <h1
              className="text-6xl font-bold bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent mb-4"
            ...
            >
              {currentLanguage === "he"
                ? "וידיאוים קדושים של תורת רבי נחמן מברסלב"
                : currentLanguage === "en"
                  ? "Keren Style - Rabbi Nachman's Wisdom Videos"
      ...
      >
        <div className="max-w-6xl mx-auto">
          <h3
            ...
            data-testid="text-video-section-title"
          >
            {currentLanguage === "he"
              ? "וידיאוים קדושים"
              : currentLanguage === "en"
            ...
            {breslovVideos.map((video, index) => (
              ...
              >
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4">{video.icon}</div>
                ...
                <div className="p-6">
                  ...
                  <p
                    className="text-gray-600 dark:text-gray-400 mb-3 text-sm line-clamp-3"
                    data-testid={`video-description-${video.id}`}
                  >
                    {getDescription(video)}
                  </p>
                  <div className="flex items-center justify-between text-sm text-gray-500 dark:text-gray-500">
                    <span data-testid={`video-speaker-${video.id}`}>
                      {video.speaker}
                    </span>
                  ...
                  <div className="mt-2">
                    <span
                      className="inline-block bg-orange-100 dark:bg-orange-900 text-orange-800 dark:text-orange-200 px-2 py-1 rounded-full text-xs"
            ...
            >
              ...
              <div className="p-6">
                ...
                <p
                  ...
                  data-testid="modal-video-description"
                >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p
              ...
              data-testid="text-footer-quote-translation"
            >
              {currentLanguage === "he"
